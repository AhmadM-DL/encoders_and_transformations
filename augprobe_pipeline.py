...
def probe(encoder, dataset, transformation, n_augmentations=10, sample_size=500, encoder_target_dim=768, random_state=42, chkpt_path="./chkpt"):
    ...
    for idx, image in enumerate(sample_data):
        ...
        for aug_idx in range(n_augmentations):
            ...
            image_ids.append(idx)  # Same ID for original and its augmentations
